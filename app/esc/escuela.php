...
<body>
				...
				<form class="form-horizontal" id="formulario" method="post">
					<fieldset>
						<div class="well">
							...
							<!-- Form Name -->
							<legend><a href="#" id="nombre"><? echo $escuela[5]; ?></a></legend>


							<div class="control-group">
								<label class="control-label" for="udi">Código de escuela</label>
								<div class="controls">
									<a href="#" id="codigo"><? echo $escuela[1]; ?></a>
								</div>
							</div>
							...
							<div class="control-group">
								...
								<div class="controls">
									<a href="#" id="distrito"><? echo $escuela[2]; ?></a>
								</div>
							</div>
							...
							<div class="control-group">
								...
								<div class="controls">
									<a href="#" id="departamento" data-type="select2" ><? echo $departamento; ?></a>
								</div>
							</div>
							...
							<div class="control-group">
								...
								<div class="controls">
									<a href="#" id="municipio" data-type="select2"><? echo $municipio; ?></a>
								</div>
							</div>
							...
							<div class="control-group">
								...
								<div class="controls">
									<a href="#" id="direccion"><? echo $escuela[6]; ?></a>
								</div>
							</div>
							...
							<div class="control-group">
								...
								<div class="controls">
									<a href="#" id="telefono"><? echo $escuela[7]; ?></a>
								</div>
							</div>
							...
							<div class="control-group">
								...
								<div class="controls">
									<a href="#" id="supervisor"><? echo $escuela[8]; ?></a>
								</div>
							</div>
							...
							<div class="control-group">
								...
								<div class="controls">
									<a href="#" id="nivel1"><? echo $nivel1; ?></a>
								</div>
							</div>
							...
							<div class="control-group">
								...
								<div class="controls">
									<a href="#" id="sector"><? echo $sector; ?></a>
								</div>
							</div>
							...
							<div class="control-group">
								...
								<div class="controls">
									<a href="#" id="status"><? echo $status; ?></a>
								</div>
							</div>
							...
							<div class="control-group">
								...
								<div class="controls">
									<a href="#" id="modalidad"><? echo $modalidad; ?></a>
								</div>
							</div>
							...
							<div class="control-group">
								...
								<div class="controls">
									<a href="#" id="jornada"><? echo $jornada; ?></a>
								</div>
							</div>
	...
	function listar_etiquetas (id_escuela) {
		...
		$.ajax({
			url: nivel_entrada+'app/src/libs/gn_escuela.php?fn_nombre=listar_esc_etiqueta&id_escuela='+<? echo $escuela["id"]; ?>,
		...
		$("#btn_nueva_tag").editable({
			url: nivel_entrada +'app/src/libs/gn_escuela.php?fn_nombre=nueva_tag&id_escuela='+<? echo $escuela["id"]; ?>,
			autotext: 'never',
			pk: <? echo $escuela["id"]; ?>,
	...
	$(document).ready(function () {
		...
		if((($sesion->get("rol"))==1)||(($sesion->get("rol"))==2)||(($sesion->get("rol"))==10)){
			...
			?>
			/* --Edición en-página */
			localStorage.id_depto_escuela = <? echo $escuela[3]; ?>;
			...
			pk: <? echo $id_escuela; ?>,			//Llave del registro a editar
...
<script type="text/javascript">
	...
	var pos_escuela = new google.maps.LatLng(<? echo $mapa[1].", ".$mapa[2] ?>);	//La posición de la escuela
	...
	function initialize() {
		...
		var infowindow = new google.maps.InfoWindow({
			content: <? echo '"<strong>'.$escuela[5].'</strong><br /><small>'.$escuela[1].'<br />Dirección: '.$escuela[6].'<br /> Teléfono: '.$telefono.'</small>"'; ?>
		});
