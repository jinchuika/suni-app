...
$(document).ready(function () {
	...
	$("#guardar_tabla").click(function() {
		...
		var fila = [];
		var cont = 0;
		var cant_filas = $('#dataTable').handsontable('countCols');
		...
		/*$.ajax({
			url: '../../src/libs/editar_nota_tabla.php',
			type: "post",
			data: {array_entrada: $('#dataTable').handsontable('getData')},
			success: function (data) {
				validar_salida = 0;
				$('#area_modal').modal('hide');
				var respuesta = $.parseJSON(data);
...
<body>
	...
	<div class="row row-fluid">
		...
		<div class="span10 well">
			...
			<div id="tablewrapper" class="hide well">
				<section>
					<legend id="grupo_actual"></legend>
					<label for="buscar_hand">Buscar: <span for="buscar_hand" id="coincide"></span></label><input type="text" id="buscar_hand">
					<div id="dataTable" style="width: 95%; overflow: scroll"></div><br>
