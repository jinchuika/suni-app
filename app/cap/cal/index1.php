<?php
/**
* -> Calendario de capacitación (Versión 2.1 añadidas asesorías)
*/
		...
		<div class="row-fluid">
			<div class="span2">
				...
				<div class="row well" id="div_nuevo_evento">
					...
					<input type="checkbox" id="habilitar_nueva" checked="true"> Habilitar nueva asistencia <br>
					<br>
					<div class="label label-info" id="nueva_asesoria">Nueva asesoría</div><br>
				</div>
			</div>
			<div class="span10">
