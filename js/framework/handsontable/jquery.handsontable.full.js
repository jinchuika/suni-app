...
(function(Handsontable){
  ...
  function createContextMenu() {
    var instance = this
      ...
      , allItems = {
        "row_above": {name: "Insertar fila arriba", disabled: isDisabled},
        "row_below": {name: "Insertar fila abajo", disabled: isDisabled},
        "hsep1": "---------",
        "col_left": {name: "Insertar columna a la izquierda", disabled: isDisabled},
        "col_right": {name: "Insertar columna a la derecha", disabled: isDisabled},
        "hsep2": "---------",
        "remove_row": {name: "Eliminar fila", disabled: isDisabled},
        "remove_col": {name: "Eliminar columna", disabled: isDisabled},
        "hsep3": "---------",
        "undo": {name: "Deshacer", disabled: function () {
          return !instance.undoRedo || !instance.isUndoAvailable();
        }},
        "redo": {name: "Rehacer", disabled: function () {
